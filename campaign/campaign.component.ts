...
//     private alertMessage: AlertMessageService, private appconfig: AppConfig, private fb: FormBuilder,
...
//         if (findex != -1) {
//           this.userName = this.usersList[findex].firstname;
//         }
//       }
//      else{
//       let findex = this.globalUsers.findIndex(y => y.userId == userSelected[0]);
//       if (findex != -1) {
//         this.userName = this.globalUsers[findex].firstname;
//       }
//      }
//     }
//   }
...
//     /* save to file */
//     let tdy = new Date();
//     let dateDownload = this.datePipe.transform(tdy, "yyyy-MM-dd h:mm:ss");
...
//   let tdy = new Date();
//   let dateDownload = this.datePipe.transform(tdy, "yyyy-MM-dd h:mm:ss");
//    doc.save('Message_Tracking_Reports_'+ dateDownload);
// }
